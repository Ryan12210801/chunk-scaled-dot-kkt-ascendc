...
public:
    ...
    __aicore__ inline void Process()
    {
        ...
        // R=3 uses chunk-local contiguous ranges. Other ratios retain
        // the validated cyclic task assignment exactly.
...
public:
    ...
    __aicore__ inline void Process()
    {
        ...
        // Keep the chunk-pair specialization deliberately narrow: only R=3
        // uses the chunk-local fast path. R=4 and every other ratio retain
        // the original cyclic loop and baseline output layout.
